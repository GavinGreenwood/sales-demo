...
{
    public class SessionAppService : SalesDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SalesDemoConsts.Currency,
                        CurrencySign = SalesDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SalesDemoConsts.AllowTenantsToChangeEmailSettings,
