...
using SalesDemo.DynamicEntityPropertyValues.Dto;

namespace SalesDemo.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : SalesDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
