...
using SalesDemo.DemoUiComponents.Dto;

namespace SalesDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SalesDemoAppServiceBase, IDemoUiComponentsAppService
    {
