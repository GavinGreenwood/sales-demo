...
using SalesDemo.Authorization.Users.Profile.Cache;
using SalesDemo.Authorization.Users.Profile.Dto;
using SalesDemo.Configuration;
using SalesDemo.Friendships;
using SalesDemo.Gdpr;
using SalesDemo.Net.Sms;
using SalesDemo.Security;
using SalesDemo.Storage;
using SalesDemo.Timing;
using SalesDemo.Url;

namespace SalesDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SalesDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SalesDemo",
