...
using SalesDemo.Migrations.Seed.Host;
...
namespace SalesDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SalesDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SalesDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SalesDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SalesDemoConsts.ConnectionStringName}", constring);
        }
