...
using SalesDemo.Auditing.Exporting;
using SalesDemo.Authorization;
using SalesDemo.Authorization.Users;
using SalesDemo.Dto;
using SalesDemo.EntityHistory;
using EntityHistoryHelper = SalesDemo.EntityHistory.EntityHistoryHelper;

namespace SalesDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SalesDemoAppServiceBase, IAuditLogAppService
    {
