...
using SalesDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SalesDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SalesDemoAppServiceBase, IDashboardCustomizationAppService
    {
