...
namespace SalesDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(SalesDemoWebCoreModule)
    )]
    public class SalesDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SalesDemoWebFrontEndModule(IWebHostEnvironment env, SalesDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SalesDemoWebFrontEndModule).GetAssembly());
        }
    }
}
