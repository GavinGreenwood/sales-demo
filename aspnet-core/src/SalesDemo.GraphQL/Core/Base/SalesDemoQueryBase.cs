...
namespace SalesDemo.Core.Base
{
    public abstract class SalesDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SalesDemoQueryBase(string fieldName,
