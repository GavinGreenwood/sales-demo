...
using SalesDemo.Core.Base;
using SalesDemo.Core.Extensions;
using SalesDemo.Dto;
using SalesDemo.Types;

namespace SalesDemo.Queries
{
    public class OrganizationUnitQuery : SalesDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
