...
namespace SalesDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SalesDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("SalesDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
