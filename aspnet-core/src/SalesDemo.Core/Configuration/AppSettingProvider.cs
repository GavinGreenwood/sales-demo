...
using SalesDemo.Authentication;
using SalesDemo.DashboardCustomization;
...
namespace SalesDemo.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!SalesDemoConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        SalesDemoConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        SalesDemoDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        SalesDemoDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = SalesDemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SalesDemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{SalesDemoDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SalesDemoDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SalesDemoDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    SalesDemoDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = SalesDemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SalesDemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{SalesDemoDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SalesDemoDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SalesDemoDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    SalesDemoDashboardCustomizationConsts.Widgets.Tenant
        ...
        {
            return new LocalizableString(name, SalesDemoConsts.LocalizationSourceName);
        }
    }
}
