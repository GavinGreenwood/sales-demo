...
{
    public class StripeGatewayManager : SalesDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SalesDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SalesDemoConsts.Currency;
        }
