...
{
    public class SalesDemoMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public SalesDemoMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(SalesDemoConsts.LocalizationSourceName, name);
        }
    }
}