...
/// </summary>
public class SalesDemoSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public SalesDemoSimplePermissionDependency()
    {
    ...
    public SalesDemoSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public SalesDemoSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
