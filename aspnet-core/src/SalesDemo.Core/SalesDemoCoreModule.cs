...
using SalesDemo.Authorization.Ldap;
using SalesDemo.Authorization.Roles;
using SalesDemo.Authorization.Users;
using SalesDemo.Chat;
using SalesDemo.Configuration;
using SalesDemo.DashboardCustomization.Definitions;
using SalesDemo.Debugging;
using SalesDemo.DynamicEntityProperties;
using SalesDemo.Features;
using SalesDemo.Friendships;
using SalesDemo.Friendships.Cache;
using SalesDemo.Localization;
using SalesDemo.MultiTenancy;
using SalesDemo.Net.Emailing;
using SalesDemo.Notifications;
using SalesDemo.WebHooks;
using Newtonsoft.Json;

namespace SalesDemo
{
    [DependsOn(
        typeof(SalesDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SalesDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SalesDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SalesDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SalesDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SalesDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SalesDemoCoreModule).GetAssembly());
        }
