...
using SalesDemo.Authentication.TwoFactor;
using SalesDemo.Chat;
using SalesDemo.Configuration;
using SalesDemo.EntityFrameworkCore;
using SalesDemo.Startup;
using SalesDemo.Web.Authentication.JwtBearer;
using SalesDemo.Web.Authentication.TwoFactor;
using SalesDemo.Web.Chat.SignalR;
using SalesDemo.Web.Common;
using SalesDemo.Web.Configuration;
using SalesDemo.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using SalesDemo.Authorization.Accounts;
...
namespace SalesDemo.Web
{
    ...
    public class SalesDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SalesDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SalesDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SalesDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SalesDemoWebCoreModule).Assembly);
        }
