...
{
    public class SalesDemoAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public SalesDemoAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
