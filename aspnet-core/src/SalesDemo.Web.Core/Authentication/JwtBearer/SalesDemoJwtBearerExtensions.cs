...
/// </summary>
public static class SalesDemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, SalesDemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
