...
using SalesDemo.Authorization.Users.Password;
using SalesDemo.Configuration;
using SalesDemo.EntityFrameworkCore;
using SalesDemo.MultiTenancy;
using SalesDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace SalesDemo.Web.Startup
{
    ...
    public class SalesDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SalesDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SalesDemoWebHostModule).GetAssembly());
        }
