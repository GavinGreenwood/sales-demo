...
{
    public class SubscriptionPaymentRepository : SalesDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SalesDemoDbContext> dbContextProvider)
