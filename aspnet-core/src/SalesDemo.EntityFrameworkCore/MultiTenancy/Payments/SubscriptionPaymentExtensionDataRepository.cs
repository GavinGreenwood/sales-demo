...
using SalesDemo.EntityFrameworkCore.Repositories;

namespace SalesDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SalesDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SalesDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
