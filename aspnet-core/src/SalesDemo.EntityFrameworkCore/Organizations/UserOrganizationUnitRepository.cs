...
namespace SalesDemo.Organizations
{
    public class UserOrganizationUnitRepository : SalesDemoRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<SalesDemoDbContext> dbContextProvider)
