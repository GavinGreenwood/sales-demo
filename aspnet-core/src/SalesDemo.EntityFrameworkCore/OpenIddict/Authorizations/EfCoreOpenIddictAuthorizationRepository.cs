...
namespace SalesDemo.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : SalesDemoRepositoryBase<OpenIddictAuthorization, Guid>,
