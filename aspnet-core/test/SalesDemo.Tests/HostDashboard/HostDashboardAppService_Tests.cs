...
using SalesDemo.MultiTenancy.HostDashboard;
...
namespace SalesDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SalesDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
